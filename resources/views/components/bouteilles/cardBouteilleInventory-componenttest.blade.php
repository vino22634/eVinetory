...
<div class="cadBouteilleCellier">
            ...
            <!-- Détails -->
            <div class="cardBoueilleCellier-details">
                
                <div id="bouteille-prix"> Quantité dans le cellier hello 222</div>
            </div>

            <!-- Quantité -->
            <div class="cardBouteilleCellier-quantity" class="icons" >
                <span>-</span>
                <span id="bouteille-quantite">2323</span>
                <span>+</span>
            </div>
