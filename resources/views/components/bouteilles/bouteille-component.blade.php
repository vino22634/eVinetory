        ...
        <div class="bouteillefooter">
            ...
            <div class="bouteilleIcons-container">
                ...
                <img class="bouteilleIcon toggle-icon"
                    ...
                    alt="Favorite" data-action="toggle" data-action-param='Favoris'>
                ...
                <img class="bouteilleIcon toggle-icon"
                    ...
                    alt="Favorite"  data-action="toggle" data-action-param='Purchase'>
                <img class="bouteilleIcon toggle-icon"
                    src="{{ true ? '/img/icons/bouteilles/cellierON@2x.png' : '/img/icons/bouteilles/cellier@2x.png' }}"
                    alt="Favorite"  data-action="toggle" data-action-param='cellier'>
            </div>
        </div>
