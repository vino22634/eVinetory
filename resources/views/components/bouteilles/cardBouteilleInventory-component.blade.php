...
@if( $bouteilleCellier->id )
    ...
    <div class="bouteilleCellier_cta">
        <div class="number-input cardBouteilleCellier-quantity">
            ...
            <input class="quantity" name="quantity" type="number" min="0" value="{{ $bouteilleCellier->quantite }}"
                id="bouteilleCellierAmount" data-id="{{ $bouteilleCellier->id }}"
...
@else
    <button class=" button-small button regular"
